const GP={rate:0.0525,termYrs:30,downPct:0.20,closingPct:0.03,pointsPct:0.01,landPct:0.20,deprecYrs:27.5,appreci:0.03,propTaxRate:0.019,insurRate:0.006,mgmtRate:0.08,repairRate:0.01,sellCostPct:0.06,cocMin:0.08,cocStrong:0.12,margRate:0.32,ltcgRate:0.15,recapRate:0.25,agi:120000};
...
function cocCalc(price,rent){if(!rent||!price)return null;const loan=price*(1-GP.downPct),annMort=pmt(loan,GP.rate,GP.termYrs)*12;const gr=rent*12,pt=price*GP.propTaxRate,ins=price*GP.insurRate,mgmt=gr*GP.mgmtRate,rep=price*GP.repairRate,oth=gr*0.05;const noi=gr-pt-ins-mgmt-rep-oth,cf=noi-annMort,ci=price*(GP.downPct+GP.closingPct);return{coc:cf/ci,cfMo:cf/12,cfAnn:cf,cashIn:ci,noi,annMort,gr,pt,ins,mgmt,rep,oth};}
