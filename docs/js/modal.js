...
function buildMod(id){
  ...
  document.getElementById('m-body').innerHTML=`
    ...
    <div class="nbhd-grid">
      ...
      ${GP.showWalkScore&&h.walkScore?`<div class="nbhd-card"><div class="nl">Walk Score</div><div class="nv" style="color:${h.walkScore>=50?'var(--green)':h.walkScore>=35?'var(--amber)':'var(--red)'}">${h.walkScore}</div><div class="nbhd-bar"><div class="nbhd-fill" style="width:${h.walkScore}%;background:${h.walkScore>=50?'var(--green)':h.walkScore>=35?'var(--amber)':'var(--red)'}"></div></div><div class="ns">Walkability</div></div>`:''}
